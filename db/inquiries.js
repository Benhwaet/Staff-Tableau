...
inquirer
    ...
    ({
    {
        ...
        },
        {
            ...
            when:
                (answers) => answers.action === "Add Department",
            validate:
                (input) => {
                    if (input === "") {
    ...
    },
{
    ...
    "What is the name of the role?",
        when:
    (answers) => answers.action === "Add Role",
        validate:
    (input) => {
        if (input === "") {
...
},
{
    ...
    "What is the employee's first name?",
        when:
    (answers) => answers.action === "Add Employee"
},
{
    type:
    "input",
...
},
{
    ...
    "Which employee's role would you like to update?",
        when:
    (answers) => answers.action === "Update Employee Role"
    choices:
    [employee list]
}
});
